...
public class D6_LP2_glue_poster_LitePlus_Best_75_RevC extends commonOps
{
    static int numberOfJobsDone = 0 ;
    static String xmlFilename = "/LP2/D6_LP2_glue_poster_LitePlus_Best_75_RevC.xml" ;
    long startTime = 0 ;
    long endTime = 0 ;
   ...
   //}
    ...
    @Test(dependsOnMethods = {"test_verifyEstimationCompleted"} , priority = 1417)
    @Description("Test Description: Verify Estimation Completed")
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 1420)
  ...
  //  }
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 1449)
    @Description("Test Description: Verify Fixer Ink Consumption")
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 1450)
