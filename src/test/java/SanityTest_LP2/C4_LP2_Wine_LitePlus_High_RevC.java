...
public class C4_LP2_Wine_LitePlus_High_RevC extends commonOps
{
    static int numberOfJobsDone = 0 ;
    static String xmlFilename = "/LP2/C4_LP2_Wine_LitePlus_High_RevC.xml" ;
    long startTime = 0 ;
    long endTime = 0 ;
    ...
    @Test(dependsOnMethods = {"test_login"} , priority = 601)
    ...
    @Test (dependsOnMethods = {"test_login"} , priority = 602)
    ...
    @Test(dependsOnMethods = {"test_login"} , priority = 603)
    ...
    @Test(dependsOnMethods = {"test_login"} , priority = 604)
    ...
    @Test(dependsOnMethods = {"test_login"} , priority = 605)
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 612)
   ...
   //}
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 614)
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 615)
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 616)
    ...
    @Test(dependsOnMethods = {"test_verifyEstimationCompleted"} , priority = 617)
    @Description("Test Description: Verify Estimation Completed")
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 619)
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 620)
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 621)
  ...
  //  @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 7140)
  ...
  //  }
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 641)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 642)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 643)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 644)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 645)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 646)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 647)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 648)
    @Description("Test Description: Verify Fixer Ink Consumption")
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 649)
    @Description("Test Description: Verify Fixer Ink Consumption")
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 650)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 660)
