...
public class H_CMYK_x4_Mondi_75_RevC extends commonOps {


    static int numberOfJobsDone = 0 ;
    static String xmlFilename = "/Sanity/H_CMYK_x4_Mondi_75_RevC.xml" ;
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 2917)
