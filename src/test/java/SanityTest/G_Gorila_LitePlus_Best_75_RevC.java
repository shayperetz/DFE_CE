...
public class G_Gorila_LitePlus_Best_75_RevC  extends commonOps  {


    static int numberOfJobsDone = 0 ;
    static String xmlFilename = "/Sanity/G_Gorila_LitePlus_Best_75_RevC.xml" ;
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 2617)
