...
public class C5_Wine_Mondi_High_RevC extends commonOps
{
    static int numberOfJobsDone = 0 ;
    static String xmlFilename = "/LP3/C5_Wine_Mondi_High_RevC.xml" ;
   ...
   //}
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 717)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 740)
