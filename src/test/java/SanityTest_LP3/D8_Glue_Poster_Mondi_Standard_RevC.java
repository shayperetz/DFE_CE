...
public class D8_Glue_Poster_Mondi_Standard_RevC extends commonOps
{
    static int numberOfJobsDone = 0 ;
    static String xmlFilename = "/LP3/D8_Glue_Poster_Mondi_STD_75_RevC.xml" ;
    ...
    @Test(dependsOnMethods = {"test_login"} , priority = 1601)
    ...
    @Test (dependsOnMethods = {"test_login"} , priority = 1602)
    ...
    @Test(dependsOnMethods = {"test_login"} , priority = 1603)
    ...
    @Test(dependsOnMethods = {"test_login"} , priority = 1604)
    ...
    @Test(dependsOnMethods = {"test_login"} , priority = 1605)
    ...
    public void test_selectTicketTemplate()
    {
       ...
       // webFlows.selectTicketTemplate(getData("TicketTemplateCSS" ,xmlFilename ));
       // verification.textInElement(costEstimator_MainScreen.ticketTemplateList, getData("TicketTemplate" ,xmlFilename ));
    }

    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 1610)
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 1611)
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 1612)
   ...
   //}
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 1614)
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 1615)
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 1616)
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 1617)
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 1618)
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 1619)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 1640)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 1641)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 1642)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 1643)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 1644)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 1645)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 1646)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 1647)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 1648)
    ...
    @Test(dependsOnMethods = {"delete_last_job_results"} , priority = 1660)
