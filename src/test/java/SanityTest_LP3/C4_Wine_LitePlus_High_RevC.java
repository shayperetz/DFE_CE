...
public class C4_Wine_LitePlus_High_RevC extends commonOps
{
    static int numberOfJobsDone = 0 ;
    static String xmlFilename = "/LP3/C4_Wine_LitePlus_High_RevC.xml" ;
   ...
   //}
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 617)
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 618)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 640)
    ...
    @Test(dependsOnMethods = {"delete_last_job_results"} , priority = 660)
