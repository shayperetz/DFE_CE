...
public class G2_Gorilla_LitePlus_Best_75_RevC extends commonOps  {


    static int numberOfJobsDone = 0 ;
    static String xmlFilename = "/LP3/G2_Gorila_LitePlus_Best_75_RevC.xml" ;
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 2517)
