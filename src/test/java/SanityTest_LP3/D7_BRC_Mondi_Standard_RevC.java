...
public class D7_BRC_Mondi_Standard_RevC extends commonOps
{
    static int numberOfJobsDone = 0 ;
    static String xmlFilename = "/LP3/D7_BRC_Mondi_STD_75_RevC.xml" ;
   ...
   //}
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 1517)
