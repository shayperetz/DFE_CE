...
public class F2_LIC_Mondi_Best_75_RevC extends commonOps
{
    static int numberOfJobsDone = 0 ;
    static String xmlFilename = "/LP3/F2_LIC_Mondi_Best_75_RevC.xml" ;
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 2217)
