...
public class D2_glue_poster_Mondi_Best_75_RevC extends commonOps
{
    static int numberOfJobsDone = 0 ;
    static String xmlFilename = "/LP3/D2_glue_poster_Mondi_Best_75_RevC.xml" ;
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 1017)
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 1018)
    ...
    @Test(dependsOnMethods = {"test_selectTicketTemplate"} , priority = 1019)
    ...
    @Test(dependsOnMethods = {"A_moreInfo_is_Open"} , priority = 1040)
